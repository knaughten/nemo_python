...
def create_ics(variable, in_file, out_file,
               source='SOSE',
               source_coord='/gws/ssde/j25b/anthrofail/birgal/NEMO_AIS/B-SOSE/climatology/SALT_climatology_m01.nc',
               nemo_coord  ='/gws/ssde/j25b/anthrofail/birgal/NEMO_AIS/bathymetry/coordinates_AIS.nc',
               nemo_mask   ='/gws/ssde/j25b/anthrofail/birgal/NEMO_AIS/bathymetry/mesh_mask-20260121.nc',
               salt_file   ='/gws/ssde/j25b/anthrofail/birgal/NEMO_AIS/B-SOSE/climatology/SALT_climatology_m01.nc', 
               folder      ='/gws/ssde/j25b/anthrofail/birgal/NEMO_AIS/initial-conditions/',
               fill_value  = np.nan,
               land_value  = np.nan,
               num_iter    = 100,
               grid_type   = 'T'):
...
def create_bcs(variable, in_file, out_file,
               ...
               nemo_mask   ='/gws/ssde/j25b/anthrofail/birgal/NEMO_AIS/bathymetry/mesh_mask-20260121.nc',
               salt_file   ='/gws/ssde/j25b/anthrofail/birgal/NEMO_AIS/B-SOSE/climatology/SALT_climatology_m01.nc', 
               folder      ='/gws/ssde/j25b/anthrofail/birgal/NEMO_AIS/boundary-conditions/B-SOSE/',
               fill_value  = np.nan,
               land_value  = np.nan,    
               bdy_ind     = 451, 
               grid_type   = 'T'):
